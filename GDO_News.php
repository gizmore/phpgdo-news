...
final class GDO_News extends GDO implements RSSItem
{
	...
	public function isVisible() { return $this->gdoVar('news_visible') === '1'; }	public function getID(): ?string { return $this->gdoVar('news_id'); }
	...
	public function isSending() { return ($this->getSentDate() === null) && ($this->getSendDate() !== null); }	public function renderName(): string { return $this->getTitle(); }
	...
	public function getMessage() { return $this->getTextVar('newstext_message_output'); }	public function getCreateDate() { return $this->gdoVar('news_created'); }
	...
	public function getMessageISO($iso) { return $this->getTextVarISO('newstext_message_output', $iso); }	public function displayDay() { return tt($this->getCreateDate(), 'day'); }
